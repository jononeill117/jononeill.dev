---
title: HomeLight
lede: The underwriting model behind Cash Close, and the automation that let it make offers without a person in the loop.
role: Product Owner, Acquisitions
...
**What I owned.** The underwriting model for Cash Close and the offer automation that ran on top of it.

**What shipped.** A model that priced the offer and a pipeline that sent it without waiting on an analyst. The model carried the book; the automation carried the volume.
