---
title: Livable
lede: A zero to one SaaS. I hired the team, shipped the product, and took it to the board every month.
...
**What I owned.** The product, from the first requirements doc to the roadmap the board saw every month. I also owned the team, because there wasn't one yet. I hired the product managers, the designers, and the business analysts who built it with me.

**What shipped.** A SaaS product from nothing to live and taking accounts. An enterprise integration that put it in front of an 8M-unit base on an evergreen basis rather than as a one-time push. A roadmap built out of what users said in interviews and support tickets instead of out of the loudest internal request.
