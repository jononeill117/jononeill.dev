---
title: Stoa
lede: Owned Portico, the underwriting platform forty analysts worked in, and rebuilt what it cost the company to say yes to a house.
role: Senior Product Manager, SaaS and Data Integrations
...
**What I owned.** Portico, the platform those forty analysts underwrote in. The data integrations feeding it and the automation sitting on top of it.

**What shipped.** One queue in place of a pile of tools. Vendor consolidation from twenty-two down to six, which cut both the bill and the number of ways a feed could break. Machine learning and automation on the steps that were only ever going to repeat, absorbing up to $4M in labor.
