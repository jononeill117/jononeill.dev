...
**What I owned.** My first enterprise product seat. Underwriting and AI models, day to day, in production rather than in a notebook.

**What shipped.** Models that ran on live inventory at a pace the team could hold, every working day, for eighteen months. This is where I learned the thing I have used at every job since: a model has users, it has a latency budget, and when it is wrong somebody has to answer for it.
