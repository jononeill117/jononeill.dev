...
lede: Product discipline pointed at a live P&L. I rebuilt intake as an automated pipeline, then had to live with the numbers it produced.
...
**What I owned.** Operations. Intake, dispatch, the office team, and the P&L all of it lands on.

**What shipped.** Intake rebuilt as an automated pipeline across the vendor work-order portal, the CSM, and VOIP. A dispatch operating system the office runs the day out of. SOPs and estimate tooling, so a new hire is useful without shadowing somebody for a month. Go to market built out of our own booking and revenue data rather than out of a guess about the market. Commercial contract work the company was not set up to quote before: sewer laterals, multi-crew renovation jobs.
